...
In the Salespointframework there is one \code{PersistenceUsermanger}, but it is not a singleton. You can instantiate a new
\code{PersistenceUsermanger} whenever you need it (it always manages the same data!).
...
\code{PersistenceUser} class which also has the basic attributes of an user.
