...
For the example of a mete a possible description could be "\code{The metre is the length of the path travelled by light in vacuum during a time interval of 1/299 792 458 of a second.}".
