...
\subsection{\code{Calendar} - The central management for appointments}
...
The \code{PersistentCalendar} itself has no identifier or other attributes, it's just a container that provides methods to easy manage all calendar entries.
