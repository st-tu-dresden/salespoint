...
\code{PersistentInventory} is an implementation of the \code{Inventory} interface. Every operation is delegated to the database, via \code{CriteriaQuery}s, but some methods require additional processing of query results with Java.
