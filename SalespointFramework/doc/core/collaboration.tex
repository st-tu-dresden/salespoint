...
\code{Catalogs} and \code{Inventorys} also work closely together with all classes in the \code{Product} package. There are a lot of other packages and classes that provide structures which are used in most packages like the \code{Money} and \code{Quantity} packages.
