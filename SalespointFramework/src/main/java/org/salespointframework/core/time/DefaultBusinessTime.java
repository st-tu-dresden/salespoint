...
class DefaultBusinessTime implements BusinessTime {
	...
	/* 
	 * (non-Javadoc)
	 * @see org.salespointframework.core.time.BusinessTime#getTime()
	 */
	@Override
	...
	/* 
	 * (non-Javadoc)
	 * @see org.salespointframework.core.time.BusinessTime#forward(java.time.Duration)
	 */
	@Override
	...
	/* 
	 * (non-Javadoc)
	 * @see org.salespointframework.core.time.BusinessTime#getOffset()
	 */
	@Override
