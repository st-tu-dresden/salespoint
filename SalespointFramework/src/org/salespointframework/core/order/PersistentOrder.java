...
public class PersistentOrder implements
	...
	// TODO Username + OrderId + Value
	@Override
	public String toString() {
		return "TODO";
	}

	// TODO remove god-attitude
	@Override
	...
	public final OrderCompletionResult completeOrder() {
		// TODO mehr CompletionStates? Jo, mehr states. Yo Dawg. I put states in
		// your states, so you can test your states while you're testing your
		// states, Dawg. oder letzten Param (Exception)
			...
			for (PersistentProduct product : products) {
				...
				if (!result) {
					PersistentOrder order = new PersistentOrder(
							this.userIdentifier, this.salesChannel,
