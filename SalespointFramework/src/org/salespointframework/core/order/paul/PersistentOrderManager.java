...
public class PersistentOrderManager implements OrderManager<PersistentOrder,PersistentOrderLine, PersistentChargeLine> {
	...
	@Override
	public Iterable<PersistentOrder> findOrders(UserIdentifier userIdentifier) {
	...
	@Override
	public Iterable<PersistentOrder> findOrders(UserIdentifier userIdentifier, DateTime from, DateTime to) {
		Objects.requireNonNull(userIdentifier, "userIdentifier");
		Objects.requireNonNull(from, "from");
		Objects.requireNonNull(to, "to");
