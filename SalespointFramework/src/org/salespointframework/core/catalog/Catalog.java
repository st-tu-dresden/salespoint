...
public interface Catalog<T extends Product>
{
	 ...
	 * TODO
	 * @param clazz type of the {@link Product} to be returned; has to implement {@link Product}
	 * @return an Iterable containing all {@link Product}s of type clazz
	 ...
	 * @return an Iterable containing all {@link Product}s of type clazz, whose productName matches name
	 ...
	 * @return an Iterable containing all {@link Product}s of type clazz, whose productCategory is category
