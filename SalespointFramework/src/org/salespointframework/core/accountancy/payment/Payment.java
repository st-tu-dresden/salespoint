...
public abstract class Payment implements Serializable {
	...
	/**
	 * Represents the time the payment was received by the payee or
	 * <code>null</code>, if the payment has not been received yet.
	 */
	private DateTime dateReceived;

	/**
	 * Represents the time, when the payee expects the payment.
	 */
	 ...
	 * @param identifier
	 *            <code>AccountancyEntryIdentifier</code> referring to the
	 *            accountancy entry for this payment
	 */
	public Payment(PaymentMethod paymentMethod, DateTime dateDue,
			AccountancyEntryIdentifier identifier) {
		this.paymentMethod = Objects.requireNonNull(paymentMethod,
				"paymentMethod");
		this.dateDue = Objects.requireNonNull(dateDue, "dateDue");
		this.accountancyEntryIdentifier = Objects.requireNonNull(identifier,
				"identifier");
	}
	...
	// payment
	// * was made by the payer or <code>null</code> representing the time the
	// payment
	...
	/**
	 * 
	 * @return identifier for the accountancy entry associated with this payment
	 *         object
	 */
