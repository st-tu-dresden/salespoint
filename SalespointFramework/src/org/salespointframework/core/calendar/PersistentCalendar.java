...
public final class PersistentCalendar implements
		...
		ICanHasClass<PersistentCalendarEntry> {

	/**
	 * The entity manager that is used to persist the entries of this calendar.
	 */
	private final EntityManager em = Database.INSTANCE
	 ...
	 */
	@Override
	public Iterable<PersistentCalendarEntry> getEntries(
			Filter<PersistentCalendarEntry> filter) {
	 ...
	 * @return An iterable with all found entries.
	 */
	public Iterable<PersistentCalendarEntry> getEntriesThatStartAfter(
			DateTime start) {
		...
		Predicate pEntry = cb.greaterThanOrEqualTo(
				r.get(PersistentCalendarEntry_.startTime), start.toDate());
	 ...
	 * @return An iterable with all found entries.
	 */
	public Iterable<PersistentCalendarEntry> getEntriesThatStartBefore(
			DateTime start) {
		Objects.requireNonNull(start, "from");
		...
		Predicate pEntry = cb.lessThanOrEqualTo(
				r.get(PersistentCalendarEntry_.startTime), start.toDate());
	 ...
	 * @return An iterable with all found entries.
	 */
	public Iterable<PersistentCalendarEntry> getEntriesThatEndBefore(
			DateTime end) {
		...
		Predicate pEntry = cb.lessThanOrEqualTo(
				r.get(PersistentCalendarEntry_.endTime), end.toDate());
	 ...
	 * @return An iterable with all found entries.
	 */
	public Iterable<PersistentCalendarEntry> getEntriesThatStartBetween(
		...
		Predicate pStart = cb.greaterThanOrEqualTo(
				r.get(PersistentCalendarEntry_.startTime), start.toDate());
		Predicate pEnd = cb.lessThanOrEqualTo(
				r.get(PersistentCalendarEntry_.startTime), end.toDate());
	 ...
	 * @return An iterable with all found entries.
	 */
	public Iterable<PersistentCalendarEntry> getEntriesThatEndBetween(
			DateTime start, DateTime end) {
		Objects.requireNonNull(start, "start");
		Objects.requireNonNull(end, "end");
		...
		Predicate pStart = cb.greaterThanOrEqualTo(
				r.get(PersistentCalendarEntry_.endTime), start.toDate());
		Predicate pEnd = cb.lessThanOrEqualTo(
				r.get(PersistentCalendarEntry_.endTime), end.toDate());
	 ...
	 * @return An {@iterable} with all found entries.
	 */
	public Iterable<PersistentCalendarEntry> getEntriesByOwner(
			final UserIdentifier owner) {
	 ...
	 */
	@Override
	public PersistentCalendarEntry getEntryByID(
