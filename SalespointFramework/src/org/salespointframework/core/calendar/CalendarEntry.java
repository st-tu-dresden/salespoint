...
public interface CalendarEntry {
	 ...
	 */
	void addCapability(UserIdentifier userIdentifier,
			CalendarEntryCapability capability);

	// TODO DB-unabhängige javadoc; db-zeug in Persistent* classes
	/**
	 ...
	 */
	Iterable<CalendarEntryCapability> getCapabilities(
	...
	//TODO immutability nicht hier doc'en
	/**
	 ...
	 */
	Iterable<UserIdentifier> getUsersByCapability(
			CalendarEntryCapability capability);
