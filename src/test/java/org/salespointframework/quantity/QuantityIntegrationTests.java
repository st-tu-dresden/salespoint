...
class QuantityIntegrationTests extends AbstractIntegrationTests {
	...
	@Autowired RepeatedNameEntityRepository repository;

	/**
	 * Verifies that an entity which embeds {@link Quantity} and repeats its attribute names can be written to the
	 * database.
	 */
	@Test
