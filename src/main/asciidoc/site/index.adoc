...
=== Current development snapshot - 7.2.x / 7.3.x snapshots
...
<dependency>
  <groupId>de.tudresden.inf.st</groupId>
  <artifactId>salespoint-framework</artifactId>
  <version>7.2.2.BUILD-SNAPSHOT</version>
</dependency>
...
<dependency>
  <groupId>de.tudresden.inf.st</groupId>
  <artifactId>salespoint-framework</artifactId>
  <version>7.3.0.BUILD-SNAPSHOT</version>
</dependency>
----
