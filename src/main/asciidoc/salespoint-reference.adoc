...
* Sample projects
** Guestbook - sample illustrating the tech stack, no SalesPoint involved.
** Videoshop - Sample web application built on top of Salespoint.
** Kickstart - Empty template project to build an app on top of Salespoint.

[[architecture.core-concepts]]
== Core concepts

[[architecture.core-concepts.ddd]]
