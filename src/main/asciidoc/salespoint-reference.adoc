...
[User]->[Password]
////
image::images/User.png[title="User"]

image::images/UserAccount.png[title="User Account"]
...
////
image::images/Catalog.png[title="Catalog"]
...
////
image::images/Accountancy.png[Accountancy, title="Accountancy"]
...
////
image::images/PaymentMethod.png[title="Payment domain types"]
...
[Order]1++-*>[ChargeLine]
////
image::images/Order(light).png[title="Order"]
...
image::images/Order_status_lifecycle.png[title="Order status lifecycle state machine"]
...
////
image::images/BusinessTime.png[title="Business time"]
